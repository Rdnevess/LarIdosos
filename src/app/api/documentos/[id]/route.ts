...
export async function GET(
  ...
  try {
    ...
    //
    // A tentativa negada FICA registrada: desde a pendência 3 da Fase 1,
    // `exigirPapel` dispara `ACESSO_NEGADO` antes de lançar. O registro é
    // amostrado numa janela deslizante de 60s (1ª, 2ª, 4ª, 8ª tentativa), para
    // uma varredura não afogar a trilha.
