...
describe('caixaDa', () => {
  ...
  it('nenhuma caixa das seis folhas sai da pagina', () => {
    ...
    // eixos, mas prova so isso: nada escapa de x em [0, LARGURA_PAGINA] nem
    // de y em [0, ALTURA_PAGINA]. Ela e cega ao sentido do eixo Y - qualquer
    // convencao autoconsistente, certa ou invertida, respeita os mesmos
    // limites, porque a altura da pagina e a mesma nos dois sentidos. Quem
    // prova o sentido sao os testes acima: a ordenacao de yDaLinha (linha 1
    // antes da linha 2) e a caixa de A11:L16.
    for (const folha of Object.values(LAYOUT)) {
